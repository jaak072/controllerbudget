...
<body>
    ...
    <div class="my-5 py-5 px-md-5 px-3 flex-grow-1">
        ...
        <div class="row mt-4">
            ...
            <!-- create plan link -->
            <div class="col-md-6 col-lg-4 col-xl-3 mt-3 offset-3">
                <div class="rounded border border-success text-success px-3 h-100 flex-column d-flex justify-content-center align-items-center">
                    <a href="new_plan" class="text-success mb-5" style="text-decoration:none;"><p class="lead mt-5"><i class="fa fa-1x fa-plus-circle"></i> Create a New Plan</p></a>
                </div>
            </div>
        </div>
    </div>
